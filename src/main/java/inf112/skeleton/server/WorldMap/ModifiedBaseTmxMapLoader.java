...
public abstract class ModifiedBaseTmxMapLoader<P extends AssetLoaderParameters<TiledMap>> extends AsynchronousAssetLoader<TiledMap, P> {

    public ModifiedBaseTmxMapLoader(FileHandleResolver resolver) {
        super(resolver);
    }
...
////                    object = tiledMapTileMapObject;
                        object = new TiledMapTileMapObject(tile,false,false);
                } else {
